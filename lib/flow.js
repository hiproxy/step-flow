...
StepFlow.prototype = {
  ...
  /**
   * Add step and functions, if the specified `step` already exists,
   * functions will be appended to the corresponding step.
   * Otherwise, a new step is created.
   *
   * @param {String} [stepName='default'] the step name that functions will be appended to.
   * @return {StepFlow}
   */
   ...
   * @param {Error|String} err the error info
   * @returns {StepFLow}
   */
